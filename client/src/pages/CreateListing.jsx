...
//     // Add any Cloudinary upload presets or tags you need
...
//                 className="flex-1 p-3 border border-gray-300 rounded-lg cursor-pointer bg-white hover:bg-gray-50 text-center"
//               >
//                 Choose Files
//                 <input
//                   className="hidden"
...
//           <button
//             type="submit"
//             className="mt-4 p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 w-full"
//           >
//             Create Listing
//           </button>
//         </div>
